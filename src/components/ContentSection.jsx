      ...
      <Container className="pt-100">
        <Row>
          ...
          <p className="mt-3">
            ...
            Aby uzyskać więcej informacji o Cortanie, kliknij tutaj , a w celu
            uzyskania dodatkowych informacji o Alexie, kliknij tutaj.
          </p>
